...
from devgagan.crawlers.douyin.web.endpoints import DouyinAPIEndpoints
# 抖音接口数据请求模型
from devgagan.crawlers.douyin.web.models import (
...
# 抖音应用的工具类
from devgagan.crawlers.douyin.web.utils import (AwemeIdFetcher,  # Aweme ID获取
...
class DouyinWebCrawler:
    ...
    async def set_douyin_cookie(self, cookie: str):
